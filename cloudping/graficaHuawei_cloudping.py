...
# === 2. CARGAR DATOS ===
csv_file = "huawei_cloudping_latency.csv"
...
# === 3. MAPEO DE CdD A CONTINENTES (Huawei) ===
# Basado en nombres reales del CSV
continent_mapping = {
    # América del Norte
    'Mexico City 1, Mexico': 'North America',
    'Mexico City 2, Mexico': 'North America',
...
# === 6. PALETA DE COLORES (MISMA QUE AWS/GCP) ===
continent_colors = {
    'Europe': '#1f77b4',        # Azul
    'North America': '#ff7f0e', # Naranja (Huawei base)
...
# === 8. ESTÉTICA ===
plt.title("Latencia desde UAM a centros de datos Huawei Cloud\n(Medias por CdD - Validación por continente)",
          fontsize=14, pad=20, fontweight='bold')
plt.xlabel("Latencia promedio (ms)", fontsize=12)
plt.ylabel("Centro de Datos (Huawei)", fontsize=12)
...
# === 10. GUARDAR ===
output_path = os.path.join(output_dir, "latencias_huawei_validacion_medias_coloreado.png")
plt.savefig(output_path, dpi=300, bbox_inches='tight')
print(f"Gráfica Huawei (coloreada por continente) guardada en: {output_path}")
plt.show()