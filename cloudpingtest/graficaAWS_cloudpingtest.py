...
# === 2. CARGAR DATOS ===
csv_file = "aws_cloudpingtest_latency.csv"
...
# === 3. MAPEO DE datacenter A CONTINENTES (basado en cloudpingtest) ===
continent_mapping = {
    # Europa
    'Paris': 'Europe',
    'Ireland': 'Europe',
...
for continent in continents:
    ...
    if len(subset) >= 2:
        fastest = subset.nsmallest(1, 'latency_ms')  # El más rápido
...
# === 6. PALETA DE COLORES (IDÉNTICA A LA DE REFERENCIA) ===
continent_colors = {
...
# === 8. ESTÉTICA (EXACTAMENTE COMO TU REFERENCIA) ===
...
# === 10. GUARDAR ===
output_path = os.path.join(output_dir, "latencias_aws_cloudpingtest_medias_coloreado.png")
plt.savefig(output_path, dpi=300, bbox_inches='tight')
print(f"Gráfica AWS (cloudpingtest) guardada en: {output_path}")
plt.show()